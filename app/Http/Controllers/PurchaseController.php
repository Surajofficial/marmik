...
class PurchaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //     'title','purchases'
        // ));
        return view('backend.purchases.index')->with(
            'purchases',$purchases
        );
    }
    ...
    public function create()
    {
       ...
       // dd($suppliers);
        return view('backend.purchases.create',compact(
            'title','categories','suppliers','product'
        ));
    }
    ...
    public function store(Request $request)
    {
        ...
        $purchases = Purchase::get();
        $notifications = "Purchase has been added";
        return view('backend.purchases.index')->with($notifications)->with('purchases',$purchases);
    ...
    public function update(Request $request, Purchase $purchase)
    {
        ...
        return redirect()->route('backend.purchases.index')->with($notifications);
    }

    public function reports(){
        $title ='purchase reports';
        return view('backend.purchases.reports',compact('title'));
    }
    ...
    public function generateReport(Request $request){
        ...
        return view('backend.purchases.reports',compact(
            'purchases','title'
        ));
    }

...
class QuestionController extends Controller
{
    ...
    {
        $question=Question::getAllQuestion();
        // return $question;
        return view('backend.Question.index')->with('questions',$question);
    }
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','question Successfully added');
        }
        else{
    ...
    public function edit($id)
    {
        ...
        return view('backend.question.edit')->with('question',$question);
    }

    ...
    <div class="card-body">
      <form method="post" action="{{route('social.store')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="iframe" name="description">{{old('iframe')}}</textarea>
          @error('iframe')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <input  id="slink" type="text" name="slink" placeholder="Enter Social Media Link"  class="form-control">
          @error('slink')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <sub style="color:red;">photo will be png</sub>
            <div class="form-group">
          <label  class="col-form-label">Video <span class="text-danger">*</span></label>
          <div class="input-group">
              
          <input  class="form-control btn" type="file" name="video" value="{{old('video')}}">
        </div>
        <div id="holder" style="margin-top:15px;max-height:100px;"></div>
          @error('video')
          <span class="text-danger">{{$message}}</span>

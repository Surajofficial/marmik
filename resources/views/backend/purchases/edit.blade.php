                                ...
                                <form class="needs-validation" novalidate id="invoice_form">
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="col-lg-2 col-sm-6">
                                                <label for="invoicenoInput" class="form-label">Purchase Type</label>
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    ...
                                                    <input type="date" class="form-control" id="date-field" data-provider="flatpickr" data-time="true" placeholder="Select Date-time">
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-sm-6">
                                            ...
                                            <table class="invoice-table table table-borderless table-nowrap mb-0">
                                                <thead class="align-middle">
                                                    <tr class="table-active">
                                                        ...
                                                        <th scope="col" class="text-end" style="width: 180px;">Purchase Price</th>
                                                ...
                                                <tbody id="newlink">
                                                    <tr id="1" class="product">
                                                        ...
                                                        <td>
                                                        <input type="text" class="form-control" id="productName-1" placeholder="Product Name"  >
                                                            <div class="invalid-feedback">
                                                                Please enter a rate
                                                            </div>
                                                        </td>

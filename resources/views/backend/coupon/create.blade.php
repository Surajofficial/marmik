...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('coupon.store')}}">
        ...
        <input id="inputTitle" type="text" name="title" placeholder="Enter Coupon Title"  value="{{old('title')}}" class="form-control">
        @error('title')
        ...
        <div class="form-group">
          ...
          <input type="radio" name='Coupen_Allowed' id='cash' value='user' > User  
		  <input type="radio" name='Coupen_Allowed' id='online' value='all' > All            
        </div>
        <div class="form-group">

    ...
    <div class="card-body">
      <form method="post" action="{{route('coupon.update',$coupon->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Enter Coupon Code"  value="{{$coupon->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          ...
          <div class="form-group">
          <label for="mode">Coupen Allowed</label><br>
          <input type="checkbox" name='Coupen_Allowed' id='cash' value='{{$coupon->Coupen_Allowed}}' {{(($coupon->Coupen_Allowed == "user") ? 'checked' : '')}}> User  
		  <input type="checkbox" name='Coupen_Allowed' id='online' value='{{$coupon->Coupen_Allowed}}' {{(($coupon->Coupen_Allowed == "all") ? 'checked' : '')}}> All            
        </div>
        <div class="form-group">

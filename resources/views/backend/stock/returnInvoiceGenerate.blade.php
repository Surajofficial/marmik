        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-center">
                    <h6 class="mb-sm-0" style="font-weight: 600">CREDIT NOTE</h6>
                </div>
            </div>
        </div>
        <!-- end page title -->
                            ...
                            <div class="card-header p-4" style="background: #fff !important;border:1px solid #ccc">
                                <div class="d-sm-flex">
                                    ...
                                    <div class="flex-shrink-0 mt-sm-0 mt-3 text-right">
                                        ...
                                        <h6 id="billing-name" class="text-color m-0"> @foreach($settings as $data) {{$data->address}} @endforeach</h6>
                                        
                                        <p class="mb-1 text-color"><span>Phone: </span><span id="billing-phone-no">
                                            @foreach($settings as $data) {{$data->phone}} @endforeach</span><br/>
                                            <span class="text-color">Timing : 10:00am - 8:00pm</span> <br>
                                            {{-- @foreach($settings as $data) {{$data->email}} @endforeach</span><br/> --}}
                                        </p><br>

                                        
                                        GSTIN : @foreach($settings as $data) {{$data->gst}} @endforeach
                                    </div>
                                </div>
                            </div>
                            <!--end card-header-->
                            ...
                            <div class="card-body" style="padding:0; !important">
                                <div class="row g-3" style="width: 100%; margin-left: 0px;">
                                    <div class="col-lg-8 " style="padding: 0;border:1px solid #ccc">
                                        <!-- <p class="text-white text-uppercase fw-medium fs-12 back-color" style="padding: .5rem; margin-bottom:0px;"><b>Bill To:</b></p> -->
                                        <div class="cust_detail">
                                            <h6 class="fs-14 mb-0">Name: {{ $invoiceData['customer_name'] ?? ''  }}</h6>
                                            @if (!empty($invoiceData['customer_email']))
                                            <h6 class="fs-14 mb-0">Email: {{ $invoiceData['customer_email'] ?? '' }}</h6>
                                            @endif
                                            <h6 class="fs-14 mb-0">Phone: {{ $invoiceData['customer_phone'] ?? '' }}</h6>
                                            <h6 class="fs-14 mb-0">Address: {{ $invoiceData['customer_address'] ?? '' }}</h6>
                                        </div>
                                    </div>
                                    <div class="col-lg-4" style="padding: .5rem 1rem; border:1px solid #ccc">
                                    <p class="text-white text-uppercase fw-medium fs-12 back-color" style="padding: .5rem; margin-bottom:0px;"><b>Issued To:</b></p>

                                        <h6 class="fs-14 m-2"><b>CASH</b> </h6>
                                        <h6 class="fs-14 m-2">Invoice Id: {{ $invoiceData['invoice_id'] ?? '' }}</h6>
                                        <h6 class="fs-14 m-2">Return Date: {{ $invoiceData['return_date'] ?? '' }}</h6>
                                    </div>
                                ...
                                <div class="row border-top" style="margin: 0 !important; margin-bottom:0px; ">
                                    <div class="col-lg-7" style="border:1px solid #ccc">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <p class="mt-2 p-2 text-right">Total Qty : {{$invoiceData['total_quantity']}}</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <h6 class="text-color"><span>{{ $invoiceData['amount_in_words'] }}</span> Rupees Only</h6>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-lg-12 p-0">
                                    ...
                                    <div class="col-lg-5 pt-3" style="border:1px solid #ccc">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 text-right text-color font-weight-bold">₹ {{ number_format($invoiceData['sub_totals'], 2) }} </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 ft">Add CGST :</div>
                                            <div class="col-lg-6 ft text-right">₹ {{ number_format($invoiceData['total_cgst'], 2) }}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 ft">Add SGST :</div>
                                            <div class="col-lg-6 ft text-right">₹ {{ number_format($invoiceData['total_sgst'], 2) }} </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 ft">Round Off(-) :</div>
                                            <div class="col-lg-6 ft text-right">₹ {{ number_format(($invoiceData['sub_totals']+$invoiceData['total_sgst']+$invoiceData['total_cgst']) - floor(($invoiceData['sub_totals']+$invoiceData['total_cgst']+$invoiceData['total_sgst'])),2)  }} </div>
                                        </div>
                                        <div class="row back-color mt-5">
                                            <div class="col-lg-6 p-2 text-white">Total (INR) :</div>
                                            <div class="col-lg-6 text-right p-2 text-white">₹ {{ floor($invoiceData['total_amount']) }}</div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 p-2">TOTAL AMOUNT :</div>
                                            <div class="col-lg-6 text-right p-2">₹ {{ floor($invoiceData['total_amount']) }}</div>
                                        </div>
                                        ...
                                        <p class="mt-5 pt-5 text-right" style="margin-bottom: 0px !important;"><b>For, Dr Awish</b></p>
                                    </div>
                                </div>

        ...
        <table class="table table-bordered" id="product-dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            @foreach($testimonials as $testimonial)   
              @php 
              $author_info=DB::table('users')->select('name')->where('id',$testimonial->added_by)->get();
              // dd($sub_cat_info);
              // dd($author_info);
                ...
                <tr>
                    ...
                    <td>
                        @if($testimonial->photo)
                            <img src="{{$testimonial->photo}}" class="img-fluid zoom" style="max-width:80px" alt="{{$testimonial->photo}}">
                        @else

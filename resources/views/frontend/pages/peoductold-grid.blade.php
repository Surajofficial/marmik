                ...
                if (productGridRight) {
                    ...
                    for (var i = (page - 1) * itemsPerPage; i < Math.min(page * itemsPerPage, datas.length); i++) {
                        ...
                        if (data && data.max_price_variant) {
                            ...
                            var layout = col3Layout ? '<div class="col-6 col-xxl-3 col-lg-4 col-md-6 mb-3 col-xs-6">' :
                        ...
                        <div class="card shadow-lg overflow-hidden element-item rounded-4 p-0 h-100 w-100" style="background-color: rgb(246, 246, 246);">
                            ...
                            <a href="${url}" class="">
                                <img src="${photos[0]}" alt="" style="height: 250px; border-radius: 20px 20px 0 0;" class="img-fluid w-100 m-0">
                            </a>
                            </div>
                            `
                            ...
                            <div class="gallery-product-actions card-image-overlay">
                                        <div class="mb-2">
                                            <button type="button" class="btn btn-danger btn-sm custom-toggle rounded-5 ${checkinput}" data-bs-toggle="button">
                            ...
                            <div class="card-body pb-0">
                                <div>
                                    ...
                                    <a href="${url}" class="w-100" style="white-space: unset;">
                                        <h6 class="fs-16 fw-500 mb-3 lh-base truncate-text">${data.title}</h6>
                                    </a>
                                    <div class="mt-3">
                                        ${afterDiscountElem}
                                    </div>

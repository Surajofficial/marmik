...
@section('title','Dr Awish || Blog Page')
                    ...
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget search">
                            <form class="form" method="GET" action="{{route('blog.search')}}">
                                ...
                                <button class="button btn btn-primary" type="sumbit"><i class="fa fa-search"></i>Submit</button>
                            </form>
                        </div>
                        <!--/ End Single Widget -->
                        <!-- Single Widget -->
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                ...
                                <form method="POST" action="{{route('subscribe')}}" class="form-inner">
                                    ...
                                    <button class="btn btn-primary" type="submit" class="btn " style="width: 100%">Submit</button>
                                </form>
                            </div>
                        </div>
                        <!--/ End Single Widget -->

                ...
                <div class="col-lg-6">
                    <div class="auth-card mx-lg-3">
                        <div class="card border-0 mb-0">
                            ...
                            <div class="card-body bg-dark bg-opacity-50 m-2 mt-0" style="box-shadow: -9px 1px 10px #b8b6b6;">
                                ...
                                <div class="p-2">
                                    <form class="form" method="post" action="{{ route('verify.otp') }}" id="otpForm">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mt-4 d-flex justify-content-center d-none" id="submit">
                                            <button class="btn btn-dark rounded-pill w-75" type="submit">Submit</button>
                                        </div>                                        
                                    </form>
                                    <!-- Email/Password Form -->
                                    {{-- <form class="form d-none" method="post" action="{{ route('login.social') }}" id="emailPasswordForm"> --}}
                                    <form class="form d-flex justify-content-center" method="post" action="{{ route('login.social') }}">
                                        @csrf
                                        {{-- <div class="mt-4 d-flex justify-content-center">
                                        ...
                                        <div class="mt-4 d-flex justify-content-center">
                                            <button type="submit" >
                                                <img src="{{asset('images/1-2.png')}}" alt="" style="width: 160px;height: 35px;" />
                                            </button>
                                        </div>
                                    </form>

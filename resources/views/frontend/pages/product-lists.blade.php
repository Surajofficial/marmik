...
@section('main-content')
		...
		<section class="ecommerce-about" style="background-image: url('https://www.awishclinic.com/wp-content/uploads/2023/06/markup-with-pencil-eyebrows_141172-3846.webp'); background-size: cover;background-position: center;">
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="text-center">
                            ...
                            @else
                            <h1 class="text-white mb-0">Product1  </h1>
                            @endif
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-light justify-content-center mt-4">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    @if(isset($types[0]))
                                    <li class="breadcrumb-item"><a href="#">{{$type[0]->title}}</a></li>
                                    @endif
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="tab-content text-muted">
                            ...
                            @foreach($type as $types)
                                <p class="text-black fs-15">{!! $types->summary !!}</p>
                            @endforeach
                            </div>
    ...
    if (document.getElementById("product-list")) {
        ...
        // Array.from(datas).forEach(function (listdata) {
            if(datas[i]){
                ...
                var myArray = datas[i].discount;
                // var myArray = text.split("%");
                
                var discount = myArray;
                ...
                if(datas[i].stock<=0)
                {
                    var but= '<div class="mt-3 hstack gap-2 justify-content-end">\
                                    <a href="#" class="btn btn-primary"> <i class="ri-bell align-bottom me-1"></i> Notify Me</a>\
                                </div>';
                }
                else
                {
                    var but =' <div class="mt-3 hstack gap-2 justify-content-end">\
                                    <a href="../../add-to-cart/' + datas[i].slug + '\" class="btn btn-primary"> <i class="ri-shopping-cart-2-fill align-bottom me-1"></i> Add To Cart</a>\
                                    <a href="../../product-detail/' + datas[i].slug + '\" class="btn btn-soft-secondary"> <i class="ri-eye-fill align-bottom"></i></a>\
                                </div>';
                }
                var photos= datas[i].photo.split(",");
                document.getElementById("product-list").innerHTML += '<div class="card ribbon-box">\
                    '+discountElem+'\
                    <div class="card-body">\
                        <div class="row">\
                            '+layout + '\
                                <div class="bg-light1 p-2 rounded-2 h-100">\
                                <a href="../../product-detail/' + datas[i].slug + '\" class="btn1"> <i class="ri-eye-fill align-bottom"></i> <img src="'+photos[0]+'" alt="" class="img-fluid">\
                                </a>\
                                </div>\
                            </div>\
                            <div class="col-md">\
                                <div>\
                                   \
                                    <a href="#!"><h4 class="fs-16">'+datas[i].title+'</h4></a>\
                                    <p class="text-muted mb-3">'+datas[i].summary+'</p>\
...
function isStatus(val) {
    ...
    if(val>0)
    {
        return ('<span class="badge bg-success-subtle text-success  align-middle ms-1">In Stock</span>');
    }
    else
    {
        return ('<span class="badge bg-danger-subtle text-danger  align-middle ms-1">out of stock</span>');
    }
   // console.log(val);

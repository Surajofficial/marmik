...
<html lang="en">
  <head>
    ...
    <title>Dr. Awish || Skin Assessment</title>
    <style>
        :root {
  ...
  <body>
    ...
    <i class="mdi mdi-arrow-left" style="font-size:larger; margin-top: 3 rem !important"></i>
        <img src="@foreach ($settings as $data) {{ $data->logo }} @endforeach" alt="logo"
         width="250" height="50" class="d-inline-block align-top">
    </a>
    </nav>
    <form action="#" class="form mt-5">
      ...
      <div class="mb-3 mt-1 ms-1 ">
                                                        ...
                                                        <div class="form-check rounded-pill bg-light py-2 px-3" style="width: 16rem">
                                                            <input class="form-check-input mx-1" type="radio" name="age" id="age1" value="1">
                                                        ...
                                                        <div class="form-check rounded-pill bg-light py-2 px-3 mt-2" style="width: 16rem">
                                                            <input class="form-check-input mx-1" type="radio" name="age" id="age2" value="2">
                                                            <label class="form-check-label mx-2 mt-1" for="age2">
                                                            19 to 25
                                                            </label>
                                                        </div>
                                                        <div class="form-check rounded-pill bg-light py-2 px-3 mt-2" style="width: 16rem">
                                                            <input class="form-check-input mx-1" type="radio" name="age" id="age3" value="3">
                                                            <label class="form-check-label mx-2 mt-1" for="age3">
                                                            25 to 30
                                                            </label>
                                                        </div>
                                                        <div class="form-check rounded-pill bg-light py-2 px-3 mt-2" style="width: 16rem">
                                                            <input class="form-check-input mx-1" type="radio" name="age" id="age4" value="4">
      ...
      <div class="mb-3 mt-1 ms-1">
                                                        ...
                                                        <div class="form-check rounded-pill bg-light py-2 px-3 mt-2" style="width: 16rem">
                                                            <input class="form-check-input mx-1" type="radio" name="skin" id="normal" value="normal">
      ...
      <div class="form-step">
      <div class="mb-3 mt-1 ms-1">
                                                        <label for="useremail" class="form-label input-group"><b>What is your primary skin concern ? </b><span class="text-danger">*</span></label>
                                                        <div class="form-check rounded-pill bg-light py-2 px-3" style="width: 16rem">
                                                            <input class="form-check-input mx-1" type="radio" name="concern1" id="acne" value="acne">
                                                            <label class="form-check-label mx-2 mt-1" for="acne">
                                                            Acne
                                                            </label>
                                                        </div>
                                                        <div class="form-check rounded-pill bg-light py-2 px-3 mt-2" style="width: 16rem">
                                                            <input class="form-check-input mx-1" type="radio" name="concern1" id="hyperpigmentation" value="hyperpigmentation">
                                                            <label class="form-check-label mx-2 mt-1" for="hyperpigmentation">
                                                            Hyperpigmentation
                                                            </label>
                                                        </div>
                                                        <div class="form-check rounded-pill bg-light py-2 px-3 mt-2" style="width: 16rem">
                                                            <input class="form-check-input mx-1" type="radio" name="concern1" id="dryness" value="dryness">
